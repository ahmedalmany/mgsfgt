...
async def update_repo(_, message: Message):
    ...
    msg = await message.reply("🔄 `تتم البرمجه بواسطة سورس سلطان ......`")
    ...
    if update_avail:
        ...
        return
    await msg.edit(f"تم الترقية بواسطه سورس [ﺳِـَـَِـَِـَـَِورـَسٰۧس ﻟﹻۧۦ. ﹻۧﺴﹻۧۦﹻۧﻠﹻۧۦﹻۧﻂﹻۧۦﹻۧﺂﺂن](https://t.me/mzxfweg)", disable_web_page_preview=True)
